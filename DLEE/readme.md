...
|--|--|--|--|--|
|W01|Mar.5|Introduction, Course overview, syllabus, grouping; the concept of digital literacy|🌀[DLW01](https://github.com/MK316/Spring2024/blob/main/DLEE/DLW01.ipynb)||
|W02|Mar.12|Python Coding: Using online platforms (Github, Colab) to write, run, save codes|🌀[DLW02-A](https://github.com/MK316/Spring2024/blob/main/DLEE/DLW02.ipynb)||
|W03|Mar.19|Basics of coding I: variables and operators, using Python packages|🌀[DLW02-B](https://github.com/MK316/Spring2024/blob/main/DLEE/DLW02.ipynb)|[^1]Tools to share|
