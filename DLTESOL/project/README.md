...
+ The language objectives include four language skills: reading, writing, speaking, and listening. You can choose from these to structure your learning activities. However, it is necessary to provide specific examples in each part to clearly demonstrate what language learning is being undertaken and what language skills are being learned.
+ For example, consider various activities such as teaching vocabulary, learning expressions, explaining grammar, reading aloud, essay writing, movie/book reviews, and/or quizzes.
